      ...
      <div className="flex h-screen  w-full justify-center">
        <div className="  flex-shrink-0">
          <div className="w-[350px] mx-auto flex flex-col  items-center">
            <Form />
            <div className="flex flex-col w-[100%] items-center text-center mt-[10px] py-[10px] px-[1px] border-igSeparator-50 border  leading-[18px]">
              <p className="text-[14px] text-center m-[15px]">
                Have an account?{' '}
                <Link to="/">
            ...
            <p className="text-[14px] mb-[10px] mt-[15px] mx-[20px]">
              Get the app.
            </p>
